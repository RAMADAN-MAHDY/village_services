...
const Navbar = () => {
  ...
  return (
    <nav className=" bg-gradient-to-r from-blue-500 to-purple-600  sm:text-[18px]  text-white py-4 shadow-md fixed top-0 w-full h-[70px] z-40">
      ...
      <img src="/Screenshot 2025-05-06 111735.png" alt="Logo" className="sm:w-[87px] w-[50px] h-[60px]" />
        ...
        <ul className="flex space-x-1 sm:space-x-4">
          ...
          <li>
            ...
            >
              <span className="relative z-10 whitespace-nowrap">اضافة || طلب</span>
              <span className="absolute rounded-3xl inset-0 bg-[#545] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 ease-in-out"></span>
            </Link>
          </li>
            <li>
            ...
            >
              <span className="relative z-10 whitespace-nowrap">الملف الشخصي</span>
              <span className="absolute rounded-3xl inset-0 bg-[#545] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 ease-in-out"></span>
            </Link>
          </li>
        </ul>
